...
public class FrontAutoParentTest {
    ...
    public void moveToCorrectLocationWithAprilTags(HardwareMap hardwareMap, Telemetry telemetry) {
        // Set up the camera object for OpenCV for AprilTag Detection
        int cameraMonitorViewId = hardwareMap.appContext.getResources().getIdentifier("cameraMonitorViewId", "id", hardwareMap.appContext.getPackageName());
        aprilTagCamera = OpenCvCameraFactory.getInstance().createWebcam(hardwareMap.get(WebcamName.class, "Webcam"), cameraMonitorViewId);
