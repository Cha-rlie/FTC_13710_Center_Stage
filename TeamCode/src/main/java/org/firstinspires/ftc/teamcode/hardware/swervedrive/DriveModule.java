...
public class DriveModule {
    ...
    public DriveModule(Robot robot, ModuleSide moduleSide) {
        ...
        if (moduleSide == ModuleSide.RIGHT) {
            motor1 = robot.hardwareMap.dcMotor.get("rightFrontMotor");
            motor2 = robot.hardwareMap.dcMotor.get("rightBackMotor");
            positionVector = new Vector2d((double)18/2, 0); //points from robot center to right module
        } else {
            motor1 = robot.hardwareMap.dcMotor.get("leftFrontMotor");
            motor2 = robot.hardwareMap.dcMotor.get("leftBackMotor");
